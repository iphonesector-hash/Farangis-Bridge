...
assert.strictEqual(parseRelativeMinutes('دو ساعت دیگه یادم بنداز'), null, 'word-number relative time is intentionally not guessed yet');
...
const reminder = parseIntent('2 ساعت دیگه یادم بنداز با مشتری تماس بگیرم');
